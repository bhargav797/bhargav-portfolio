...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (aboutText) {
    aboutText.textContent =
      "I am an MSc IT student and aspiring Full-Stack Developer who enjoys building scalable, user-friendly, and efficient applications. I love turning complex problems into clean, well-structured solutions—whether on the frontend or backend. I focus on writing maintainable, high-quality code and continuously expanding my skill set by working on real-world projects, exploring new technologies, and refining my development workflow.";
  }
